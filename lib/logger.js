...
Logger.prototype.getLevel = function() {
    if (this.level === undefined && this.parent) {
...
Logger.prototype.log = function(level, message) {
    ...
    var le = new LoggingEvent(this.name, level, format.apply(null, args));
...
Logger.prototype.trace = function() {
    this.log(Levels.TRACE, format.apply(null, arguments));
};
...
Logger.prototype.debug = function() {
    this.log(Levels.DEBUG, format.apply(null, arguments));
};
...
Logger.prototype.info = function() {
    this.log(Levels.INFO, format.apply(null, arguments));
};
...
Logger.prototype.warn = function() {
    this.log(Levels.WARN, format.apply(null, arguments));
};
...
Logger.prototype.error = function() {
    this.log(Levels.ERROR, format.apply(null, arguments));
};
